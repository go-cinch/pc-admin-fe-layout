<template>
  <div class="art-card h-100 p-5 mb-5 max-sm:mb-4">
    <div class="art-card-header">
      <div class="title">
        <h4>{{ $t('dashboardContent.analysis.targetVsReality') }}</h4>
      </div>
    </div>
  ...
  const totalItems = computed(() => [
    {
      ...
      label: $t('dashboardContent.analysis.actualSales'),
      subLabel: $t('dashboardContent.analysis.global'),
      value: '8,823',
    ...
    },
    {
      ...
      iconClass: 'text-theme bg-theme/12',
      label: $t('dashboardContent.analysis.targetSales'),
      subLabel: $t('dashboardContent.analysis.commercial'),
      value: '12,122',
      valueClass: 'text-theme'
    }
  ])
