...
// The file is generated by the Vite auto-import plugin and is intentionally
// absent from a freshly generated Scaffold project until the first dev/build run.
...
export default [
  ...
  // 自定义规则
  {
    ...
    rules: {
      ...
      // TypeScript and vue-tsc validate identifiers. Fresh generated projects
      // do not yet have the optional auto-import ESLint globals file.
      'no-undef': fs.existsSync(autoImportPath) ? 'error' : 'off',
