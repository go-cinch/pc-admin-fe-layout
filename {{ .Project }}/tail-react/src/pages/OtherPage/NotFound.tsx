...
export default function NotFound({ className }: NotFoundProps) {
  ...
  return (
    <>
      <PageMeta
        title={`${t("notFound.title")} | TailAdmin`}
      ...
      >
        ...
        <Copyright
          className={cn(
            "absolute inset-s-1/2 bottom-6 -translate-x-1/2 text-center text-sm text-gray-500 rtl:translate-x-1/2 dark:text-gray-400 [&_a]:text-brand-500",
          )}
        />
      </div>
    </>
