...
describe('dateUtils', () => {
  ...
  describe('formatDateTime', () => {
    ...
    it('should format the same timestamp in the selected timezone', () => {
      const timestamp = Date.parse('2024-01-01T00:00:00Z');

      setCurrentTimezone('America/New_York');
      expect(formatDateTime(timestamp)).toBe('2023-12-31 19:00:00');

      setCurrentTimezone('Asia/Shanghai');
      expect(formatDateTime(timestamp)).toBe('2024-01-01 08:00:00');
    });
  });
